...
fn test_mnemonic_length() {
    for length in [MnemonicLength::Words12, MnemonicLength::Words18, MnemonicLength::Words24] {
...
fn test_mnemonic_length_from_word_count() {
    assert_eq!(MnemonicLength::from_word_count("12").unwrap(), MnemonicLength::Words12);
    assert_eq!(MnemonicLength::from_word_count("18").unwrap(), MnemonicLength::Words18);
    assert_eq!(MnemonicLength::from_word_count("24").unwrap(), MnemonicLength::Words24);
...
fn test_mnemonic_from_valid_phrase() {
    ...
    assert_eq!(hex::encode(mnemonic.entropy()), "00000000000000000000000000000000");
}
