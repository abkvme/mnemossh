...
### Changed
- Updated dependencies to their latest releases: `aes` 0.9.3, `clap` 4.6.7, and
  `console` 0.16.6, along with a full refresh of the transitive dependency
  lockfile. No API or behaviour changes.
